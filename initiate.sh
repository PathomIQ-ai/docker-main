...
if [ ${MODE} == 'train' ] 
then
    git clone https://ml-and-ml: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@github.com/PathomIQ-ai/CNN-train-predict.git /home/ec2-user/download/
    ...
    --pretrain_checkpoint ${PRETRAIN_CHECKPOINT} --split_type ${SPLIT_TYPE} --scheduler ${SCHEDULER} --patch_sizes ${PATCH_SIZES}
fi
...
then
    git clone https://ml-and-ml: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@github.com/PathomIQ-ai/CNN-train-predict.git /home/ec2-user/download/
    python /home/ec2-user/download/lung_features.py --slide ${SLIDE} --pretrain_epoch ${PRETRAIN_EPOCH}
fi
...
then
    ...
    git clone https://ml-and-ml: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@github.com/PathomIQ-ai/lung-response.git /home/ec2-user/download/
...
then
    ...
    --pretrain_epoch ${PRETRAIN_EPOCH} --pretrain_run ${PRETRAIN_RUN} 
fi