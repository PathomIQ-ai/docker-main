...
if [ ${MODE} == 'train' ] 
then
    git clone https://ml-and-ml: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@github.com/PathomIQ-ai/CNN-train-predict.git /home/ec2-user/download/
...
then
    ...
    git clone https://ml-and-ml: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@github.com/PathomIQ-ai/lung-response.git /home/ec2-user/download/
